...
![Silk Sonic / An Evening With Silk Sonic](../../images/cd/silksonic1L.jpg)
	...
	<Column colMd={"4"} colLg={"8"} noGutterMdLeft="">
		<p>
			...
			<br/>ユニット作ではあるが、Produce面含めて、全般的にBruno Mars色が強く、Anderson .PaakらしいHip-Hop色は皆無でVocalに専念している。また、Booty Collinsが数曲において声で参加しており、花を添えている。
...
<Row >
	...
	<Column colMd={"8"} colLg={"8"} noGutterMdLeft="">
		<div>
			...
			<h3>Guests</h3>
			<p>
				Thundercat, Booty Collins, Babyface
			</p>
		</div>
	</Column>
</Row>
