...
![Tyler, The Creator / Call Me If You Get Lost](../../images/cd/tyler5L.jpg)
    ...
    <Button className="button-right-mergin"  href="https://amzn.to/3s0XTif" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      amazon.co.jp
		...
		<Button className="button-right-mergin"  href="https://geo.music.apple.com/us/album/call-me-if-you-get-lost/1573484415?itsct=music_box_link&itscg=30200&at=11lcug&ct=albums_call_me_if_you_get_lost&ls=1&app=music" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      apple music
    </Button>
		<AdvJS2/>
	</div>
